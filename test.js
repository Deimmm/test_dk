...
(function () {
  ...
  function O(e, a) {
    return a != null && typeof Symbol != "undefined" && a[Symbol.hasInstance]
    ...
    try {
      for (
        ...
        var _ = de(v.value, 2),
          ...
          w;
        (y.watchcat.seq = ge),
          y.watchcat.lastAckedSeq === 0 && (y.watchcat.lastAckedSeq = ge);
        var p = z(f);
        if (!p) {
          g(
        ...
        if (
          (y.isExecuting ||
            !y.isInitialized ||
            (y.isInitialized && !y.isStale && !y.isExecuted)) &&
          y.watchcat.lastAckedSeq !== 0 &&
          y.watchcat.lastAckedSeq < y.watchcat.seq - 1 - Nt
        ) {
          (y.watchcat.lastAckedSeq = 0),
            (y.watchcat.seq = 0),
            console.log("Turnstile Widget seem to have crashed: ", f),
            window.postMessage(
              {
                source: j,
                widgetId: f,
  ...
  function xt() {
    var e = [Ze, et];
    xe && e.push(tt),
      document.querySelectorAll(e.join(", ")).forEach(function (a) {
        return He.render(a);
      });
  }
  var qe = [],
  ...
  function Be(e, a) {
    var i,
      s = (i = a.params.size) !== null && i !== void 0 ? i : "normal",
      u = a.mode;
    switch (u) {
      ...
      default:
        d(
          'Invalid value for parameter "mode", expected "'
            .concat(k.NON_INTERACTIVE, '", "')
            .concat(k.MANAGED, '" or "')
            .concat(k.INVISIBLE, '", got "')
            .concat(u, '"'),
          2818,
        );
        return;
  ...
  function mt(e, a, i, s) {
    var u = Ut(i),
      v = "h/".concat("b", "/");
    return ""
      .concat(u, "/cdn-cgi/challenge-platform/")
      .concat(v, "turnstile/if/ov2/av0/rcv")
      .concat(s, "/")
      .concat(e, "/")
      .concat(a, "/")
      .concat(i.theme, "/")
  ...
  var He = (function () {
    var e = function (c, t, n) {
        if (c.params.retry === ae.AUTO || n) {
          ...
          var r,
            l = n
              ? 0
              : 1e3 * 2 +
                ((r = c.params["retry-interval"]) !== null && r !== void 0
                  ? r
                  : 0);
      ...
      i = function (c) {
        if (!c) return [];
        for (
          var t = c.attributes, n = t.length, r = new Array(n), l = 0;
          l < n;
          l++
        )
          r[l] = t[l].name;
      ...
      s = function () {
        ...
        do {
          c = "";
          for (
            var t = "abcdefghijklmnopqrstuvwxyz0123456789", n = t.length, r = 0;
            r < 5;
            r++
          )
      ...
      v = function (c, t) {
        if (t) {
          ...
          t["after-interactive-callback"] &&
            (c.cbAfterInteractive = t["after-interactive-callback"]),
            t["before-interactive-callback"] &&
              (c.cbBeforeInteractive = t["before-interactive-callback"]),
            t.callback && (c.cbSuccess = t.callback),
            t["expired-callback"] && (c.cbExpired = t["expired-callback"]),
            t["timeout-callback"] && (c.cbTimeout = t["timeout-callback"]),
            t["error-callback"] && (c.cbError = t["error-callback"]),
            t["unsupported-callback"] &&
              (c.cbUnsupported = t["unsupported-callback"]),
            t.chlPageData && (c.chlPageData = t.chlPageData);
        }
      },
      _ = function (c) {
        var t = L(c);
        ...
        if (n) {
          (n.isResetting = !0),
            ...
            (n.watchcat.seq = 0),
            n.params.execution === K.RENDER &&
              (n.msgQueue.push(q.EXECUTE),
              (n.isExecuted = !0),
              (n.isExecuting = !0));
          var r = z(t),
          ...
          if (
            (n.params.appearance === W.INTERACTION_ONLY && _t(l),
            n.params.sitekey === null)
          ) {
      ...
      f = function (c) {
        ...
        var o =
          (t = x.get(n)) === null || t === void 0 ? void 0 : t.retryTimeout;
      ...
      y = function (c, t) {
        ...
        if (l) {
          ...
          var I;
          o.execution =
            (I = o.execution) !== null && I !== void 0 ? I : K.RENDER;
          var X;
          o.appearance =
            (X = o.appearance) !== null && X !== void 0 ? X : W.ALWAYS;
          var Q;
          o["retry-interval"] =
            (Q = o["retry-interval"]) !== null && Q !== void 0 ? Q : it;
          var $;
          ...
          if (typeof b != "string") {
            d(
              'Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(
                typeof b == "undefined" ? "undefined" : R(b),
                '"',
              ),
              3588,
            );
          ...
          var Ee,
            ne =
              (Ee = o["refresh-expired"]) !== null && Ee !== void 0
                ? Ee
                : D.AUTO;
          if (Ue(ne)) o["refresh-expired"] = ne;
            ...
            d(
              'Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'
                .concat(ne, '" ')
                .concat(typeof ne == "undefined" ? "undefined" : R(ne)),
              3603,
            );
            return;
          }
          ...
          if (!(!ue || !J)) {
            ...
            x.set(ue, {
              ...
              C.setAttribute("src", mt(ue, b, o, H)),
              ...
              (C.id = J);
            var Te;
            (C.tabIndex = (Te = o.tabindex) !== null && Te !== void 0 ? Te : 0),
              (C.title = "Widget containing a Cloudflare security challenge"),
              n.appendChild(C);
            var Ie,
              It =
                (Ie = o["response-field"]) !== null && Ie !== void 0 ? Ie : !0;
            if (It) {
              ...
              if (
                ((le.name =
                  (Se = o["response-field-name"]) !== null && Se !== void 0
                    ? Se
                    : nt),
                (le.id = "".concat(J, "_response")),
                n.appendChild(le),
                typeof o["response-field-name"] != "string" && Wt(b))
              ) {
                var se = document.createElement("input");
                (se.type = "hidden"),
                  (se.name = rt),
                  (se.id = "".concat(J, "_legacy_response")),
                  n.appendChild(se);
              }
            }
            if (xe) {
    ...
    function S() {
      return (
        (S = Ye(function (m, c, t, n) {
          var r, l, o, h, E, A, b, T, B;
          return pe(this, function (I) {
            switch (I.label) {
              case 0:
                if (((r = m.params.sitekey), (l = gt()), !l))
                  return (
                    g(
                ...
                (o = "h/".concat("b", "/")),
                  ...
                  (A = ""
                    .concat(E, "://")
                    .concat(h.host, "/cdn-cgi/challenge-platform/")
                    .concat(o, "rc/")
                    .concat(n)),
                  (I.label = 1);
              case 1:
              ...
              case 3:
                return [4, b.json()];
              case 4:
                if (((T = I.sent()), "status" in T && T.status === "redeemed"))
                  return a(m, c, !0), [2];
                I.label = 5;
              case 5:
                return [3, 7];
            ...
            if (!(!n || !r))
              switch (t.event) {
                case "init": {
                  ...
                  (r.mode = t.mode),
                    r.mode === k.INVISIBLE &&
                      r.params["refresh-expired"] === D.MANUAL &&
                      g(
                        "refresh-expired=manual is impossible in invisible mode, consider using '"
                          .concat(D.AUTO, "' or '")
                          .concat(D.NEVER, "'"),
                      ),
                    r.params.appearance === W.ALWAYS ? Be(l, r) : _t(l),
                    (l.style.display = "");
                  break;
                }
                ...
                case "food": {
                  r.watchcat &&
                    t.seq > r.watchcat.lastAckedSeq &&
                    (r.watchcat.lastAckedSeq = t.seq);
                  break;
                }
                case "complete": {
                  (r.rcV = H),
                    (r.response = t.token),
                    t.sToken ? p(r, n, t.sToken, t.chlId) : a(r, n, !1);
                  break;
                }
                case "fail": {
                  t.rcV && (r.rcV = t.rcV),
                  ...
                  if (b) {
                    var T;
                    b(
                      (T = t.code) !== null && T !== void 0
                        ? T
                        : "undefined_error",
                    ) || (t.code && g(t.code), e(r, n, t.code === "crashed"));
                  } else
                    t.code
                      ? (e(r, n, t.code === "crashed"), d(t.code, 3076))
                      : e(r, n, !1);
                  break;
                }
                case "feedbackInit":
                ...
                case "tokenExpired": {
                  ...
                  var I = r.cbExpired;
                  I && I(B),
                    r.params["refresh-expired"] === D.AUTO &&
                      !r.isResetting &&
                      _(n);
                  break;
                }
                ...
                case "interactiveEnd": {
                  ...
                  if (!be) {
                    d(
                      "Cannot unlayout widget, Element not found (#".concat(
                        n,
                        ").",
                      ),
                      3077,
    ...
    return {
      ready: function (c) {
        if (
          ...
          typeof c != "function" &&
            d(
              'turnstile.ready() expected a "function" argument, got "'.concat(
                typeof c == "undefined" ? "undefined" : R(c),
                '"',
              ),
              3841,
            ),
          ...
          typeof c != "function" &&
            d(
              'Invalid value for parameter "callback", you must provide a callback function as argument to ready()',
              3842,
            ),
          bt)
        ) {
        ...
        if (l) {
          ...
          if (l.response) {
            (l.isExecuting = !1),
              ...
              l.cbSuccess && l.cbSuccess(l.response, !1);
            return;
          }
          l.isStale && _(o),
            l.isExpired &&
            ...
            l.msgQueue.push(q.EXECUTE),
            (l.isExecuted = !0);
          var h = document.querySelector("#".concat(o));
          if (!h) {
            (l.isExecuting = !1),
              d("Widget ".concat(o, " to execute was not found"), 43522);
            return;
          }
          l.isInitialized && u(l, n, h),
            l.params.appearance === W.EXECUTE && Be(h, l);
        }
      },
      render: y,
      reset: _,
        ...
        if (typeof c == "undefined") {
          ...
          if (n) {
            ...
            return (
              ...
              (r = x.get(n)) === null || r === void 0 ? void 0 : r.response
            );
      ...
      isExpired: function (c) {
        ...
        if (typeof c == "undefined") {
          ...
          if (n) {
            var r, l;
            return (l =
              (r = x.get(n)) === null || r === void 0
                ? void 0
                : r.isExpired) !== null && l !== void 0
              ? l
              : !1;
          } else d("Could not find a widget", 43794);
        }
        var o = L(c);
        if (!o)
          return d("Could not find widget for provided container", 43778), !1;
        var h;
        return (h =
          (t = x.get(o)) === null || t === void 0 ? void 0 : t.isExpired) !==
          null && h !== void 0
          ? h
          : !1;
      },
  ...
  function Ft(e) {
    ...
    u &&
      (Ce(u) ? (i.theme = u) : g('Unknown data-theme value: "'.concat(u, '"')));
    var v = e.getAttribute("data-size");
    if (
      (v &&
        (Pe(v) ? (i.size = v) : g('Unknown data-size value: "'.concat(v, '"'))),
      !1)
    )
      var _;
    ...
    var l,
      o =
        (l = e.getAttribute("data-response-field")) !== null && l !== void 0
          ? l
          : "true";
  ...
  Y &&
    ((ee = Y.get("compat")),
    (ee == null ? void 0 : ee.toLowerCase()) === "recaptcha"
      ? window.grecaptcha
        ? g(
            "grecaptcha is already defined. The compatibility layer will not be enabled",
          )
        : (g("Compatibility layer enabled"),
          (xe = !0),
          (window.grecaptcha = He))
      : ee !== null &&
        g('Unknown value for api.js?compat: "'.concat(ee, '", ignoring')),
    Y.forEach(function (e, a) {
      M(["onload", "compat", "render"], a) ||
        g(
          'Unknown parameter passed to api.js: "?'.concat(a, '=...", ignoring'),
        );
    }),
    (N = Y.get("onload")),
    N &&
          ...
          : (g(
            ...
            setTimeout(function () {
              typeof window[N] == "function"
                ...
                : g(
                    "Unable to find onload callback '"
                      .concat(N, "' after 1 second, expected 'function', got '")
                      .concat(R(window[N]), "'"),
                  );
            }, 1e3));
      }, 0));
  ...
  Bt
    ...
    : ((window.turnstile = He),
      (Y == null ? void 0 : Y.get("render")) !== "explicit" && qe.push(xt),
      document.readyState === "complete" ||
      document.readyState === "interactive"
        ? setTimeout(yt, 0)
        : window.addEventListener("DOMContentLoaded", yt));
})();
